...
void rwkv7_v4_bf16_to_f16_launch(
    hipStream_t stream, const uint16_t* src_bf16, uint16_t* dst_f16, long long elems);

void rwkv7_v4_bf16_to_f16_transpose_launch(
    hipStream_t stream, const uint16_t* src_bf16, uint16_t* dst_f16, int rows, int cols);

void rwkv7_v4_f16_transpose_launch(
    hipStream_t stream, const uint16_t* src_f16, uint16_t* dst_f16, int rows, int cols);

void rwkv7_v4_emb_ln0_bf16_to_f16_launch(
    hipStream_t stream, int V, int C,
...
void rwkv7_v4_f16_to_f32_launch(
    hipStream_t stream, const half* src_f16, float* dst_f32, long long elems);

void rwkv7_wkv_fp16_seq_launch(
    hipStream_t stream, int B, int T, int C, int H,
...
void rwkv7_wkv_fp16_one_launch(
    hipStream_t stream, int B, int C, int H,
    half* state, const half* r, const half* w, const half* k, const half* v,
    const half* a, const half* b, half* y, const int* elapsed_t);

void rwkv7_wkv_fp32io16_launch(
    hipStream_t stream, int B, int T, int C, int H, int mode,
...
void rwkv7_tmix_mix6_launch(
    hipStream_t stream, int B, int T, int C,
...
void rwkv7_relu_square_launch(hipStream_t stream, const half* x, half* out, long long elems);
void rwkv7_act_tanh_launch(hipStream_t stream, const half* x, half* out, long long elems);
void rwkv7_act_sigmoid_launch(hipStream_t stream, const half* x, half* out, long long elems);

void rwkv7_add_vec_launch(
    hipStream_t stream, int C, const half* x, const half* vec, half* out, long long elems);

void rwkv7_cmix_sparse_down_relu_one_launch(
    hipStream_t stream, int C, int F, const half* preact, const half* value_fc, half* out);

void rwkv7_cmix_sparse_down_relu_rows_launch(
    hipStream_t stream, int B, int T, int C, int F,
...
void rwkv7_cmix_sparse_one_launch(
    hipStream_t stream, int C, int F,
...
void rwkv7_v3a_add_f16_launch(
    hipStream_t stream, const half* x, const half* y, half* out, long long elems);

void rwkv7_v3a_advance_i32_launch(hipStream_t stream, int* x, int amount, long long elems);

void rwkv7_v3a_layer_norm_f16_launch(
    hipStream_t stream, int rows, int C,
...
void rwkv7_v3a_linear_t_f16_launch(
    hipStream_t stream, int M, int K, int N,
...
void rwkv7_v3a_linear_wag_rank_in_f16_launch(
    hipStream_t stream, int M, int K, int Rw, int Ra, int Rg,
...
void rwkv7_v3a_linear_wagv_rank_in_f16_launch(
    hipStream_t stream, int M, int K, int Rw, int Ra, int Rg, int Rv,
...
void rwkv7_v3a_linear_wag_rank_out_f16_launch(
    hipStream_t stream, int M, int C, int Kw, int Ka, int Kg,
...
void rwkv7_v3a_linear_wagv_rank_out_f16_launch(
    hipStream_t stream, int M, int C, int Kw, int Ka, int Kg, int Kv,
